...
void loop() {
  ...
  ThingSpeak.writeField(mychannelnum,2,bpm,myAPI);
  ThingSpeak.writeField(mychannelnum,3,h,myAPI);
  ThingSpeak.writeField(mychannelnum,4,t,myAPI);
}
